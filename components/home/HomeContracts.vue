...
<template>
  <div class="flex gap-2">
    <NuxtLink
      ...
      :key="index"
      class="font-medium underline underline-offset-2 flex items-center gap-1 p-1 hover:bg-gray-200 rounded transition-colors duration-300 dark:hover:bg-gray-700"
